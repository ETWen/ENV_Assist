...
# Underload config.
nscmd.t451_config_under_power(1000) # 0.01w
nscmd.t451_config_under_timeout(3000) # ms
# Set Config.
...
time.sleep(1)
# relay off per slot
print("Start underload test-1.")
nscmd.t451_open_relay(chassis_idx, slot1_idx, 1)
time.sleep(1)
isShowChart = True
#thread.start_new_thread(ShowInstantVoltage, (chassis_idx, slot1_idx,))
# start underload test
nscmd.t451_start_underload(chassis_idx, slot1_idx)

#print("Start underload test-2.")
#nscmd.t451_open_relay(chassis_idx, slot2_idx, 0)
#time.sleep(1)
#nscmd.t451_start_underload(chassis_idx, slot2_idx)
...
print("Show underload test report...")
nscmd.t451_report_underload(chassis_idx, slot1_idx)
# relay off - group
