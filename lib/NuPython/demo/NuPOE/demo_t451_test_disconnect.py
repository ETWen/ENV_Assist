...
# Disconnect config.
nscmd.t451_config_disconn_timeout(3000) # ms
# Set Config.
...
time.sleep(1)
# relay off per slot
print("Start disconnect test-1.")
nscmd.t451_open_relay(chassis_idx, slot1_idx, 1)
time.sleep(1)
isShowChart = True
#thread.start_new_thread(ShowInstantVoltage, (chassis_idx, slot1_idx,))
# start disconnect test
nscmd.t451_start_disconnect(chassis_idx, slot1_idx)

#print("Start disconnect test-2.")
#nscmd.t451_open_relay(chassis_idx, slot2_idx, 0)
#time.sleep(1)
#nscmd.t451_start_connect(chassis_idx, slot2_idx)
...
print("Show disconnect test report...")
nscmd.t451_report_disconnect(chassis_idx, slot1_idx)
# relay off - group
