...
# Loading config.
nscmd.t451_config_load_mode(nsconst.T451_CFG_LOADING_STEP)
nscmd.t451_config_load_powermin(1) # 0.01w
nscmd.t451_config_load_powermax(50000)
# Set Config.
...
time.sleep(1)
# relay off per slot
print("Start loading test-1.")
nscmd.t451_open_relay(chassis_idx, slot1_idx, 1)
time.sleep(1)
isShowChart = True
#thread.start_new_thread(ShowInstantVoltage, (chassis_idx, slot1_idx,))
# start loading test
nscmd.t451_start_loading(chassis_idx, slot1_idx)

#print("Start loading test-2.")
#nscmd.t451_open_relay(chassis_idx, slot2_idx, 0)
#time.sleep(1)
#nscmd.t451_start_loading(chassis_idx, slot2_idx)
time.sleep(5)
nscmd.t451_stop_loading(chassis_idx, slot1_idx)
...
print("Show loading test report...")
nscmd.t451_report_loading(chassis_idx, slot1_idx)
# relay off - group
