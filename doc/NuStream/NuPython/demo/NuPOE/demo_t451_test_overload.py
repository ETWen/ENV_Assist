...
# Overload config.
nscmd.t451_config_over_power(5000) # 0.01w
nscmd.t451_config_over_timeout(3000) # ms
# Set Config.
...
print("Show overload test report...")
nscmd.t451_report_overload(chassis_idx, slot1_idx)
# relay off - group
