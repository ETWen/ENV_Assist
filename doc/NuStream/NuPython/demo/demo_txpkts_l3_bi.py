...
nscmd.config_stream_sip(ip_2)
nscmd.config_stream_dip(ip_1)
...
time.sleep(2)
print "Port 1   Send:%i   Received:%i" % (nscmd.get_counter_port(port1_idx, nsconst.IDX_PORTCOUNTER_TX_PKT), nscmd.get_counter_port(port1_idx, nsconst.IDX_PORTCOUNTER_RX_GOODPKT))
print "Port 2   Send:%i   Received:%i" % (nscmd.get_counter_port(port2_idx, nsconst.IDX_PORTCOUNTER_TX_PKT), nscmd.get_counter_port(port2_idx, nsconst.IDX_PORTCOUNTER_RX_GOODPKT))
